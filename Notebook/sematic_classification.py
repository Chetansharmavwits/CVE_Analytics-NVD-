...
classifier = pipeline("zero-shot-classification", model="Model/bart-large-mnli")
...
df = pd.read_excel('/Users/aplynek/Documents/Streamlit-Business-analytics-with-MySQL-main/Results/Component_File.xlsx')
